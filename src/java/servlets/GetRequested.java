 ...
 * @author marilena_sch
 */
public class GetRequested extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (int i = 0; i < book_copies.size(); i++) {
                ...
                for (int j = 0; j < borr.size(); j++) {
                    if (borr.get(j).getStatus().equals("requested")) {
            ...
            Logger.getLogger(GetRequested.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
